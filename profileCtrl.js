var profiles = [
  ...
  },
  {
    ...
    status: ' FLUFFLES DID THE CUTEST THING TODAY'
  }
];
...
module.exports = {
  var newArray = [];
  for (var i = 0; i < req.session.currentUser.length; i++) {
    req.session.currentUser.friends.push(newArray);
